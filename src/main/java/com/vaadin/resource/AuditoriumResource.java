...
public class AuditoriumResource {
    ...
    public List<AuditoriumModel> findAll(){
        ResponseEntity<List<AuditoriumModel>> result = restTemplate.exchange(RESOURCE_URL + "/all", HttpMethod.GET, null, new ParameterizedTypeReference<List<AuditoriumModel>>() {});
